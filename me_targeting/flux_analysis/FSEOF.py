...
class FSEOF(Simulator.Simulator):
    ...
    def run_FSEOF(self, biomass_rxn, target_rxn):
        ...
        print ('Target minimum flux : ', min_const, 'Target maximum flux : ', max_const)
    ...
    def result_summary(self):
        ...
        new_cov = cov.sort_values(by='Unnamed: 0', ascending=False)
        top_new_cov = new_cov['Unnamed: 0']
        new_cov = cov.sort_values(by='Unnamed: 0', ascending=True)
